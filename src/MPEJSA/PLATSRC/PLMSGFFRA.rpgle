      ...
      *  --------  -----  -----  -------------------------------------*
      *  07/13/20   R001  JB/PS  Band-aid for WILSTE w/ 2 TMS Convo's *
      *  07/16/20   R002  JB/PS  Ditto for Z1ARAA                     *
      *                                                               *
      *****************************************************************
...
AR001      yajl_addChar('conversation');
           yajl_beginObj();
AR001    if driverID = 'WILSTE';
  |      yajl_addChar('subject':'Conversation with Driver: +
  |                              WILSTE - STEPHEN WILLIS');
  |      yajl_addBool('read_only':'0');
  |      yajl_addBool('is_group_chat':'0');
  |      yajl_addChar('external_id':'7bc685a7-fa46-435a-ba11-0ffbe89b4c53');
AR001    endif;
AR002    if driverID = 'Z1ARAA';
  |      yajl_addChar('subject':'Conversation with Driver: +
  |                              Z1ARAA - ADAN ARAUJO');
  |      yajl_addBool('read_only':'0');
  |      yajl_addBool('is_group_chat':'0');
  |      yajl_addChar('external_id':'29be298d-9804-4809-8e75-d313f0e40b6c');
AR002    endif;
         yajl_endObj();

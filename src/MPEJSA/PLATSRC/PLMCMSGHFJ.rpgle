...
AR009D sendFFmsg2      PR                  ExtPgm('PLMSGFFR2')
  |  D  unit                          6a
  |  D  passdate                      7s 0
AR009D  passtime                      6s 0
...
AX001     //Sendload(unit#:mode:Pplan:order#:disp#:ldmil:mtmil);
       ...
       // changed to write to a transaction processing file
         ...
         PLMHTIME = a_mhtime;
         write plaoordr;
AR009    sendFFMsg2(a_mhunit:a_mhdate:a_mhtime);
...
AR003  //  enddo;
  |    //deeplink = *blanks;
DR009  //sendFFmsg(driver:message:deeplink);
         endsr;
       //-------------------------------------------------------------
